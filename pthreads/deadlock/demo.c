...
/*
suppose that , one thread executes line 25 : pthread_mutex_lock(&mutexFuel);
another thread executes line : 29 : pthread_mutex_lock(&mutexWater);

one thread is waiting for water and another is waiting for fuel
